...
public class ApplicationCli {
    ...
    private void printHelp() throws IOException {
        ...
        formatter.printHelp(pw, 100, APPLICATION, "----------", options, 0, 0, "----------", true);
        pw.flush();
        pw.close();
        context.exceptionList.add(new AntException(out.toString()));
        out.close();
    }
    ...
    private void createParser(String[] args) throws ParseException {
        options = new Options();
        options.addRequiredOption("af", CLI_OPTION_ANT_FILE, true, "relative or absolute path to the main ant file. This parameter is not optional.");
